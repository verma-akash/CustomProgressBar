...
public class CustomProgressBar extends FrameLayout {
    ...
    private CustomProgressBar.OnProgressLabelInteractionListener mListener;
    ...
    public void addProgressForms(CustomProgressBar.OnProgressLabelInteractionListener listener, @NotNull List<? extends CustomProgressModel> formsModelList) {
