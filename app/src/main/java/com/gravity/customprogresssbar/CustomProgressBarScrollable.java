...
public class CustomProgressBarScrollable extends FrameLayout {
    ...
    private CustomProgressBarScrollable.OnProgressLabelInteractionListener mListener;
    ...
    public void addProgressForms(CustomProgressBarScrollable.OnProgressLabelInteractionListener listener, @NotNull List<? extends CustomProgressModel> formsModelList) {
...
//            int maxProgress = formsModelList.get(i).getSectionCount();
//            float intervalWidth = mTotalProgressBarWidth / (maxProgress);
//            int padding = (int) (0.7 * intervalWidth);
//
//            for (int j = 0; j < maxProgress; j++) {
//                View view = new View(getContext());
//                view.setBackgroundColor(getResources().getColor(R.color.white));
//                LinearLayout.LayoutParams params = new LinearLayout.LayoutParams((int) intervalWidth - padding, 2);
